...
urlpatterns = [
    ...
    url(r'^group/from_search$',views.GroupFromSearchView.as_view(),name='group_from_search', ),
    #many groups
    ...
    url(r'^group_rule-autocomplete/$',views.GroupRuleAutocomplete.as_view(),name='group_rule-autocomplete', ),
    # rules
